...
class transitospagorabot : 
    def __init__(self, config, logging) : 
        self.apikey = config['TELEGRAM']['TRANSITOSPAGORA_APIKEY']
        self.usersfile = config['TELEGRAM']['TRANSITOSPAGORA_USERS']
        self.adminsfile = config['TELEGRAM']['TRANSITOSPAGORA_ADMINS']
        self.helpfile = config['TELEGRAM']['TRANSITOSPAGORA_HELPFILE']
        self.adminhelpfile = config['TELEGRAM']['TRANSITOSPAGORA_ADMINHELPFILE']
    ...
    def start(self) :
        self.logging.info('Starting Transito SP Agora Bot') 
        self.updater.start_polling()
        self.broadcastAdmins("Starting Transito SP Agora Bot v0.1")
        self.updater.idle()
    ...
    def hndlrStart(self, update, context) : 
        message = """
            Transiito SP Agora Bot. Bem-vindo.
        ...
        if bnewadminid == b'' : 
            ...
            with dbm.open(self.adminsfile, 'c') as db : 
                if bnewadminid in db.keys() : 
                    ...
                    self.logging.info('New administrator: ' + newadminname + ' (userid: ' + str(bnewadminid) + ')')
