...
class alagamentosbot : 
    def __init__(self, config, logging) : 
        self.apikey = config['TELEGRAM']['ALAGAMENTOS_APIKEY']
        self.usersfile = config['TELEGRAM']['ALAGAMENTOS_USERS']
        self.adminsfile = config['TELEGRAM']['ALAGAMENTOS_ADMINS']
        self.helpfile = config['TELEGRAM']['ALGAMENTOS_HELPFILE']
        self.adminhelpfile = config['TELEGRAM']['ALGAMENTOS_ADMINHELPFILE']
    ...
    def start(self) :
        self.logging.info('Starting alagamentos bot') 
        self.updater.start_polling()
        self.broadcastAdmins("Starting Alagamentos SP Bot v0.1")
        self.updater.idle()
